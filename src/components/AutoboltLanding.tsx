          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            <div className="space-y-6 md:space-y-8">
              <div className="text-center h-16 flex items-center justify-center">
                <div className="inline-flex items-center gap-2 md:gap-3 bg-red-100 text-red-700 px-4 md:px-6 py-2 md:py-3 rounded-full font-bold text-base md:text-xl border border-red-200">
                  🔴 PROBLEMA
                </div>
              </div>
            ...
            <div className="space-y-6 md:space-y-8">
              <div className="text-center h-16 flex items-center justify-center">
                <div className="inline-flex items-center gap-2 md:gap-3 bg-green-100 text-green-700 px-4 md:px-6 py-2 md:py-3 rounded-full font-bold text-base md:text-xl border border-green-200">
                  🟢 SOLUÇÃO
                </div>
              </div>
              {problemSolutions.map((item, index) => (
          ...
          <Card className="max-w-2xl mx-auto card-floating">
            <CardContent className="p-12">
              <div className="space-y-8">
                ...
                <Button className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold w-full text-sm sm:text-base md:text-lg lg:text-xl py-3 md:py-4 lg:py-5 px-2 sm:px-3 md:px-4 lg:px-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                  CONTRATAR AUTOBOLT
